...
LivingArea = st.number_input("Living Area", format="%d", step=1)
PostalCode = st.number_input("Postal Code", format="%d", step=1)
BathroomCount = st.number_input("BathroomCount", format="%d", step=1)
BedroomCount = st.number_input("BedroomCount", format="%d", step=1)
...
NumberOfFacades = st.number_input("Number of Facades", format="%d", step=1)
Garden = st.selectbox("Garden", ("Yes", "No"))
GardenArea = st.number_input("Garden Area", format="%d", step=1)
SwimmingPool = st.selectbox("Swimming Pool", ("Yes", "No"))
Terrace = st.selectbox("Terrace", ("Yes", "No"))
ConstructionYear = st.number_input("Construction Year", format="%d", step=1)
